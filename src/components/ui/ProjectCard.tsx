    ...
    >
      ...
      >
        ...
        <div className="project-content p-6 flex-1 flex flex-col">
          ...
          {/* Action Buttons */}
          <div className="project-actions mt-auto flex flex-col gap-3">
            <div className="flex gap-3">
              {links.demo && (
                <Button
                  as="a"
            ...
            <Button
              ...
              aria-controls={`case-study-${title.replace(/\s+/g, "-").toLowerCase()}`}
            >
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              className="case-study border-t border-gray-200 overflow-hidden"
            >
              <div className="p-6 space-y-4">
                <div>
                  <h4 className="heading-sm text-primary mb-2">Problem</h4>
                ...
                <div>
                  <h4 className="heading-sm text-primary mb-2">Approach</h4>
                  <p className="body-md text-text-secondary">
                    {caseStudy.approach}
                  </p>
                </div>
                ...
                <div>
                  <h4 className="heading-sm text-primary mb-2">Outcome</h4>
                  <p className="body-md text-text-secondary">
                    {caseStudy.outcome}
                  </p>
                </div>
