...
export const IsometricScene: React.FC<IsometricSceneProps> = ({
  ...
  const rotate1 = useSpring(useTransform(scrollY, [0, 300], [0, 15]), springConfig);
  const rotate2 = useSpring(useTransform(scrollY, [0, 300], [0, -10]), springConfig);
  const scale1 = useSpring(useTransform(scrollY, [0, 300], [1, 1.1]), springConfig);
